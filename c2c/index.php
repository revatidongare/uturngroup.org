...
<head>
    ...
    <title>UTurn Group : Campus to career</title>
...
<div id="preloader">
    ...
    <div id="layerslider" style="width:100%;height:650px;">
        ...
        <div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
        	...
        	<h3 class="ls-l slide_typo" style="top: 45%; left: 50%;" data-ls="offsetxin:0;durationin:2000;delayin:1000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotatexout:90;transformoriginout:50% bottom 0;" > <strong>Proper</strong> Guidance</h3>
    ...
    <div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
        	...
        	<h3 class="ls-l slide_typo" style="top: 45%; left: 50%;" data-ls="offsetxin:0;durationin:2000;delayin:1000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotatexout:90;transformoriginout:50% bottom 0;" >Uturn <strong>Qualified</strong> counsellors</h3>
            <!-- <p class="ls-l slide_typo_2" style="top:52%; left:50%;" data-ls="durationin:2000;delayin:1000;easingin:easeOutElastic;" >COLLEGE / UNIVERSITY / CAMPUS</p>
     ...
     <div class="ls-slide" data-ls="slidedelay:5000; transition2d:5;" >
        	...
        	<h3 class="ls-l slide_typo" style="top: 45%; left: 50%;" data-ls="offsetxin:0;durationin:2000;delayin:1000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotatexout:90;transformoriginout:50% bottom 0;" ><strong>Large </strong> networks</h3>
<!--             <p class="ls-l slide_typo_2" style="top:52%; left:50%;" data-ls="durationin:2000;delayin:1000;easingin:easeOutElastic;" >COLLEGE / UNIVERSITY / CAMPUS</p>
            <p class="ls-l" style="top:65%; left:50%;" data-ls="durationin:2000;delayin:1300;easingin:easeOutElastic;" ><a href="tour.html" class="button_intro">Take a tour</a> <a href="about.html" class="button_intro outline">About us</a></p> -->
    </div>
    ...
    <div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
        <img src="img/slides/slide_1.jpg" class="ls-bg" alt="Slide background">
        	<h3 class="ls-l slide_typo" style="top: 45%; left: 50%;" data-ls="offsetxin:0;durationin:2000;delayin:1000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotatexout:90;transformoriginout:50% bottom 0;" ><strong>Proper planning</strong> and step by step execution</h3>
            <!-- <p class="ls-l slide_typo_2" style="top:52%; left:50%;" data-ls="durationin:2000;delayin:1000;easingin:easeOutElastic;" >COLLEGE / UNIVERSITY / CAMPUS</p>
            <p class="ls-l" style="top:65%; left:50%;" data-ls="durationin:2000;delayin:1300;easingin:easeOutElastic;"><a href="tour.html" class="button_intro">Take a tour</a> <a href="about.html" class="button_intro outline">About us</a></p> -->
    </div>
    	...
    	<div class="row">
        	<div class="col-md-4 col-sm-4">
            	 <div class="home_feat_1_box">
                        <a href="#">
                        <img src="img/gaurantee.jpg" class="img-responsive" alt="">
                        <div class="short_info"><h3>Guaranteed Placement</h3><i class="arrow_carrot-right_alt2"></i></div>
                        </a>
                    </div>
            </div>
            <div class="col-md-4 col-sm-4">
           <div class="home_feat_1_box">
                        <a href="#">
                        <img src="img/parents.jpg" class="img-responsive" alt="">
                        <div class="short_info"><h3>Counselling sessions with parents</h3><i class="arrow_carrot-right_alt2"></i></div>
                        </a>
                    </div>
            </div>
            <div class="col-md-4 col-sm-4">
           <div class="home_feat_1_box">
                        <a href="#">
                        <img src="img/seminar.jpg" class="img-responsive" alt="">
                        <div class="short_info"><h3>Seminars in College</h3><i class="arrow_carrot-right_alt2"></i></div>
                        </a>
                    </div>
            </div>
        </div><!-- End row -->
    ...
    <h2>A perfect career guiding platform for MBA and Hotel Management students</h2>
    <p>We provide perfect skills needed for cracking a job interview to college students or recent graduates which will help them to conduct a successful search for a job.</p>
    </div>
    	<div class="row">
        	<div class="col-md-6 col-sm-6">
            	<div class="box_feat_home">
                    ...
                    <p>Resume is given the attention which it deserves , afterall it is the first thing a hiring manager or a recruiter sees. So, if you're looking for that first job out of college, we will provide you this resume essentials like <b>Templates</b>, <b>Objective</b>, <b>GPA(Grade Point Average)</b>, decision to know if resume should be <b>One Page v/s Multiple Pages</b>.</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
            	<div class="box_feat_home">
                    ...
                    <p>Technology has brought about tremendous changes in the types of work positions available. Video interviews are perfect examples because they connect you with an interviewer through a screen and help you display your candidacy for positions that aren’t near your home. So, while conducting a mock interview by us, we will guide you with some tips like <b>Effective Speaking</b>, <b>Dressing Professionally</b>,<b>Relating your life experiences to skills or characteristics</b> which are effective for in-person interviews also.</p>
                </div>
            </div>
        </div><!-- End row -->
        <div class="row">
        	<div class="col-md-6 col-sm-6">
            	<div class="box_feat_home">
                	...
                	<h3>Seminars in College</h3>
                    <p>We are conducting seminars in all the MBA and Hotel Management colleges across Maharashtra and give the students a brief of campus recruiting process.</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
            	<div class="box_feat_home">
                	...
                	<h3>Counselling</h3>
                    <p>We believe in connecting people to their purpose. We are going to help and guide you to your destiny. We are going to help you to remove all the wrong notions and wrong perspectives about your career. A session to understand your visualization about your future. A session to find out your likes, dislikes, and your hidden talents. A face to face session will help you to interact and get all the queries cleared. Online counseling/On call counseling also available.</p>
                </div>
            </div>
        </div><!-- End row -->
        <div class="row">
        	<div class="col-md-6 col-sm-6">
            	<div class="box_feat_home">
                    ...
                    <p>A proficiency test measures a learner's level of language. It can be compared with an achievement test, which evaluates a learner's understanding of specific material, a diagnostic test, which identify areas to work on, and a prognostic test, which tries to predict a learner's ability to complete a course or take an exam. Proficiency tests are uncommon within the classroom but very frequent as the end aim (and motivation) of language learning. We will conduct this proficiency test to understand the students ability.</p>
                </div>
            </div>
            <!-- <div class="col-md-6 col-sm-6">
            	<div class="box_feat_home">
        ...
        <div class="row add_bottom_60">
            <div class="main_title">
            <h2>Uturngroup focus on these ....</h2>
            <p>Trust that our students are learning skills that will serve them well in the future</p>
            </div>
            ...
            <img src="img/graphic.jpg" class="wow zoomIn" data-wow-delay="0.1s" alt="">
            	...
            	<h4><strong>01.</strong> Taking a hard look at soft skills</h4><p>Soft skills relate to how you work. Soft skills include interpersonal (people) skills, communication skills, listening skills, time management, and empathy, among others. Hiring managers typically look for job candidates with soft skills because they make someone more successful in the workplace.</p>
                </div>
                <div class="features step_2 wow zoomIn" data-wow-delay="1.5s">
                <h4><strong>02.</strong> Ways to make a great impression at you job interview</h4><p>Believe it or not – finding the position and getting your resume in front of the right person was actually the easy part. Get ahead of the interview game this hiring season with the help of our guidance about the things you can do to ensure you make a great first impression at your upcoming job interview.</p>
                </div>
                <div class="features step_3 wow zoomIn" data-wow-delay="2s">
                <h4><strong>03.</strong>  What New Grads Need to Know</h4><p>Did you just graduate from college? Are you contemplating everything that comes next? Whether you’re relocating to pursue work, we will provide you can’t-miss tips for new grads looking to make a change.</p>
                </div>
                <div class="features step_4 wow zoomIn" data-wow-delay="2.5s">
                <h4><strong>04.</strong> How to Stay Positive in Your Job Search</h4><p>A very lucky few finish college and graduate straight into the job they’ve always dreamed of. For many, the end of college signals the start of a long and potentially demoralizing job hunt. It’s tough out there! If you’re contending with a long job hunt, you should <b>Keep Things in Perspective</b>, <b>Seek out the Support of Friends and Family</b> and <b>Stick With Quality over Quantity</b></p>
                </div>
                </div>
                </div>
            </div>
           	<div class="text-center"><a href="tour.html" class=" button_outline large">Take a tour of Uturn</a></div>
    </div>
    ...
    <div class="container margin_60">
          <div class="main_title">
    <h2>We Provide</h2>
    <!-- <p>Step by step process to find an internship or job</p> -->
    
        <p>Sessions with counsellors over voice call, video call or in person</p>
        <p>Proficiency Test</p>
        <p>Resume Building</p>
        <p>Mock Interview</p>
        <p>Seminars in College</p>
        <p>Interview Cracking Guidance</p>
        <p>Impressive Resume Format</p>
        <p>Structured Skill Highlighting</p>
        <p>Job Offering Suggestions</p>
        <p>Internship Offerings</p>
        <p>How to impress recruiters and Profrssionals</p>    
